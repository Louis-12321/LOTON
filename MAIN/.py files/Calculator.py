...
class Calculator(QWidget):
    ...
    def update_button_sizes(self):
        ...
        for meta in getattr(self, 'button_meta', []):
            ...
            btn.setProperty("_loton_original_stylesheet", stylesheet)
    ...
    def _reapply_theme(self):
        from Theme_Manager import CURRENT_THEME, apply_theme_to_open_windows as apply
        apply(CURRENT_THEME)
