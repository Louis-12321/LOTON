...
class Login(QWidget):
    ...
    #      VERSION TEXT
    #==========================
        self.versiontext = QLabel("LOTON OS v1.1.0.0", self.content)
    ...
    def handle_guest_mode(self):
        QMessageBox.information(
            self,
            "Guest Mode",
            "Guest mode enabled. Proceeding without credentials."
        )
        self.login_success()
        self.bootloton.show()
    ...
    def activate_loading_screen(self):
        # Placeholder for activating the loading screen after login
        pass
